...
class ProblemasMatematicosScreen extends StatefulWidget {
  ...
  @override
  State<ProblemasMatematicosScreen> createState() =>
      _ProblemasMatematicosScreenState();
}

class _ProblemasMatematicosScreenState
    extends State<ProblemasMatematicosScreen> {
  ...
  List<ProblemaMatematico> get _problemasFiltrados {
    return _todosLosProblemas
        .where((p) => p.nivel == _nivelSeleccionado)
        .toList();
  }
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            _buildInfoRow(
                Icons.emoji_events, 'Gana monedas por cada acierto', AppTheme.verde),
            const SizedBox(height: 6),
            _buildInfoRow(
                Icons.rocket_launch, '4 niveles de dificultad', Colors.blue),
          ],
        ),
        actions: [
          SizedBox(
  ...
  void _cargarProblemas() {
    _todosLosProblemas.addAll([
      ...
      ProblemaMatematico(
          ...
          nivel: 'base',
          pregunta:
              'En una caja hay 18 lombrices y en otra hay 24. ¿Cuántas lombrices hay en total?',
      ...
      ProblemaMatematico(
          ...
          nivel: 'base',
          pregunta:
              'En un lombricario había 60 lombrices. Si regalaron 18, ¿cuántas quedaron?',
          respuestaCorrecta: '42',
          opciones: ['38', '42', '44', '48'],
          monedasGanadas: 2,
          emoji: '➖'),
      ProblemaMatematico(
          ...
          nivel: 'base',
          pregunta:
              'Cada caja tiene 30 lombrices. Si hay 7 cajas, ¿cuántas lombrices hay en total?',
      ...
      ProblemaMatematico(
          ...
          nivel: 'base',
          pregunta:
              'Una lombriz produce 2 gramos de humus por semana. Si hay 25 lombrices, ¿cuántos gramos de humus producen en una semana?',
      ...
      ProblemaMatematico(
          ...
          nivel: 'base',
          pregunta:
              'Si una bolsa de humus pesa 5 kg y se llenan 8 bolsas, ¿cuántos kilogramos de humus hay en total?',
      ...
      ProblemaMatematico(
          ...
          nivel: 'base',
          pregunta:
              'En el huerto se usaron 36 kg de humus y quedaban 52 kg almacenados. ¿Cuántos kilogramos había al principio?',
      ...
      ProblemaMatematico(
          ...
          nivel: 'base',
          pregunta:
              'Un grupo de estudiantes recolectó 48 cáscaras de frutas. Si las repartieron en 6 cajas para las lombrices, ¿cuántas cáscaras pusieron en cada caja?',
          respuestaCorrecta: '8',
          opciones: ['6', '7', '8', '9'],
          monedasGanadas: 2,
          emoji: '➗'),
      ProblemaMatematico(
          ...
          nivel: 'base',
          pregunta:
              'Hay 54 lombrices y se quieren repartir por igual en 9 recipientes. ¿Cuántas lombrices habrá en cada recipiente?',
          respuestaCorrecta: '6',
          opciones: ['4', '5', '6', '7'],
          monedasGanadas: 2,
          emoji: '📦'),
      ...
      ProblemaMatematico(
          ...
          nivel: 'bronce',
          pregunta:
              'Una familia separó 4 kg de residuos orgánicos cada día durante 7 días. ¿Cuántos kilogramos separaron en total?',
      ...
      ProblemaMatematico(
          ...
          nivel: 'bronce',
          pregunta:
              'Si una bolsa de humus cuesta \$35 y una persona compra 4 bolsas, ¿cuánto debe pagar?',
      ...
      ProblemaMatematico(
          ...
          nivel: 'bronce',
          pregunta:
              'Una escuela vendió 9 bolsas de humus a \$40 cada una. ¿Cuánto dinero obtuvo?',
      ...
      ProblemaMatematico(
          ...
          nivel: 'bronce',
          pregunta:
              'En un taller participaron 32 niños. Si se formaron equipos de 4 integrantes, ¿cuántos equipos se hicieron?',
          respuestaCorrecta: '8',
          opciones: ['6', '7', '8', '9'],
          monedasGanadas: 3,
          emoji: '👥'),
      ProblemaMatematico(
          ...
          nivel: 'bronce',
          pregunta:
              'Una lombriz mide aproximadamente 8 cm. Si colocas 6 lombrices una tras otra, ¿cuántos centímetros medirían en total?',
      ...
      ProblemaMatematico(
          ...
          nivel: 'bronce',
          pregunta:
              'Se recolectaron 72 hojas secas y se repartieron en 8 montones iguales. ¿Cuántas hojas quedaron en cada montón?',
          respuestaCorrecta: '9',
          opciones: ['7', '8', '9', '10'],
          monedasGanadas: 3,
          emoji: '🍂'),
      ProblemaMatematico(
          ...
          nivel: 'bronce',
          pregunta:
              'Si cada planta necesita 2 puños de humus y hay 18 plantas, ¿cuántos puños de humus se necesitan?',
      ...
      ProblemaMatematico(
          ...
          nivel: 'bronce',
          pregunta:
              'En una semana nacieron 40 lombrices nuevas. Si ya había 125, ¿cuántas hay ahora?',
      ...
      ProblemaMatematico(
          ...
          nivel: 'plata',
          pregunta:
              'Se prepararon 10 cajas para lombrices y en cada una se colocaron 15 lombrices. ¿Cuántas lombrices se utilizaron?',
      ...
      ProblemaMatematico(
          ...
          nivel: 'plata',
          pregunta:
              'Si un kilogramo de humus cuesta \$28 y una persona compra 6 kg, ¿cuánto pagará?',
      ...
      ProblemaMatematico(
          ...
          nivel: 'plata',
          pregunta:
              'En un huerto había 96 plantas. Si se abonaron primero 58, ¿cuántas plantas faltan por abonar?',
      ...
      ProblemaMatematico(
          ...
          nivel: 'plata',
          pregunta:
              'En el criadero hay 8 cajas con 25 lombrices cada una. ¿Cuántas lombrices hay en total?',
      ...
      ProblemaMatematico(
          ...
          nivel: 'plata',
          pregunta:
              'Si una lombriz cuesta \$1.50 y un cliente compra 6, ¿cuánto debe pagar?',
      ...
      ProblemaMatematico(
          ...
          nivel: 'plata',
          pregunta:
              'Se vendieron 15 lombrices a \$1.50 cada una. ¿Cuánto dinero se obtuvo?',
      ...
      ProblemaMatematico(
          ...
          nivel: 'plata',
          pregunta:
              'Hay 240 lombrices y se quieren repartir en 8 cajas con la misma cantidad. ¿Cuántas lombrices irán en cada caja?',
      ...
      ProblemaMatematico(
          ...
          nivel: 'plata',
          pregunta:
              'Se tienen 180 lombrices y cada cliente compra 12. ¿A cuántos clientes se les puede vender?',
      ...
      ProblemaMatematico(
          ...
          nivel: 'oro',
          pregunta:
              'Una lombriz cuesta \$1.50. ¿Cuánto costarán 28 lombrices?',
      ...
      ProblemaMatematico(
          ...
          nivel: 'oro',
          pregunta:
              'Si 20 lombrices cuestan \$30, ¿cuánto costarán 45 lombrices si el precio por lombriz es el mismo?',
      ...
      ProblemaMatematico(
          ...
          nivel: 'oro',
          pregunta:
              'En una semana se vendieron 120 lombrices. Si cada una costó \$0.50, ¿cuál fue el ingreso total?',
      ...
      ProblemaMatematico(
          ...
          nivel: 'oro',
          pregunta:
              'Un criadero tenía 500 lombrices. Vendió 175 y después nacieron 80 más. ¿Cuántas lombrices tiene ahora?',
      ...
      ProblemaMatematico(
          ...
          nivel: 'oro',
          pregunta:
              'Si 20 lombrices cuestan \$30, ¿cuánto costarán 50 lombrices?',
      ...
      ProblemaMatematico(
          ...
          nivel: 'oro',
          pregunta:
              'Si 80 lombrices cuestan \$120, ¿cuánto costarán 150 lombrices?',
      ...
      ProblemaMatematico(
          ...
          nivel: 'oro',
          pregunta:
              'Un cliente compró 40 lombrices por \$60. Si otro cliente quiere 75 lombrices, ¿cuánto deberá pagar?',
      ...
      ProblemaMatematico(
          ...
          nivel: 'oro',
          pregunta:
              'Si con 100 lombrices se pueden iniciar 4 camas de lombricomposta, ¿cuántas camas se pueden iniciar con 250 lombrices?',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: SafeArea(
          child: SingleChildScrollView( // ✅ ENVUELTO EN SCROLL
            padding: const EdgeInsets.all(16),
            child: Column(
              children: [
                // Niveles
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      ...
                      return Container(
                        ...
                        decoration: BoxDecoration(
                          color: const Color.fromARGB(255, 255, 254, 254).withOpacity(0.15),
                          borderRadius: BorderRadius.circular(12),
                        ),
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            const Icon(Icons.today, color: Color.fromARGB(255, 14, 13, 13), size: 18),
                            const SizedBox(width: 8),
                            Text(
                              'Hoy: $resueltos/5',
                              style: const TextStyle(
                ...
                Container(
                  ...
                  child: _mostrarResultado ? _buildResultado() : _buildProblema(),
                ),
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                  ...
                  color: isSelected ? color : const Color.fromARGB(255, 2, 2, 2),
                ),
              ),
            ],
          ),
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(fontSize: 11, color: colorNivel),
                    ),
                  ),
                ],
              ),
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: _problemaRespondido &&
                                  opcion == problema.respuestaCorrecta
                              ? AppTheme.verde
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Icon(iconoFinal, size: 56, color: colorFinal),
          ),
          const SizedBox(height: 12),
          Text(
            tituloFinal,
